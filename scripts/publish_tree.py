...
Usage:
    uv run python scripts/publish_tree.py <tree_name> [--update-snapshot]
...
from ai_tree.publisher import publish  # noqa: E402
...
def main() -> int:
    ...
    result = publish(args.name, update_snapshot=args.update_snapshot)
    print(result.report())
